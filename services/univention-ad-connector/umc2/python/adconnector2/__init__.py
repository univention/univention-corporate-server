...
#  Configuration of the UCS Active Directory Connector of the local system
#
...
_ = Translation( 'univention-management-console-module-adconnector2' ).translate
...
class Instance( Base ):
	...
	def configuration( self, request ):
		...
		self.finished( request.id, {
			...
			'subject' : 'Test mail from univention-management-console-module-adconnector2',
