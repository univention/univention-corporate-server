			...
			this.pages = [{
				...
				widgets: [{
					...
					content: _paragraph(
						...
						_('To enable an encrypted connection, a certification authority needs to be configured on the Active Directory server. All steps necessary are described in the <a href="https://docs.software-univention.de/manual-4.0.html#ad-connector:ad-zertifikat" target="_blank">UCS manual</a>.'),
