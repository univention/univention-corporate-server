				...
				if (!state.certificate) {
					if (!state.ssl_enabled) {
						...
						certMsg = makeParagraphs([
							...
							_('The necessary steps depend on the actual Microsoft Windows version and are described in the <a href="http://docs.software-univention.de/manual-4.4.html#ad-connector:ad-zertifikat" target="_blank">UCS manual</a>.')
						]);
					} else {
						certMsg = makeParagraphs([
