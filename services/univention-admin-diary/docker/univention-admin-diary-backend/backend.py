...
create_entry_parser.add_argument('args', type=dict, required=True, help='TODO.')
create_entry_parser.add_argument('timestamp', type=datetime_from_iso8601, required=True, help='TODO.')
create_entry_parser.add_argument('tags', type=str, action='append', required=True, help='TODO.')
