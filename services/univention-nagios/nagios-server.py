...
__initscript='/etc/init.d/nagios2'

#
# /etc/nagios2/conf.univention.d/services/<SERVICENAME>,<HOSTFQDN>.cfg
# /etc/nagios2/conf.univention.d/hosts/<HOSTFQDN>.cfg
# /etc/nagios2/conf.univention.d/hostgrps/<GRPNAME>.cfg
# /etc/nagios2/conf.univention.d/contacts/<EMAILADDR>.cfg
# /etc/nagios2/conf.univention.d/contactgrps/<HOSTFQDN>.cfg
# /etc/nagios2/conf.univention.d/timeperiods/<PERIODNAME>.cfg
#

__confdir = '/etc/nagios2/conf.univention.d/'
...
def createContact( contact ):
	...
	try:
		...
		fp.write('    host_notification_commands     host-notify-by-email\n')
		fp.write('    service_notification_commands  notify-by-email\n')
		fp.write('    email                          %s\n' % contact)
		fp.write('}\n')
		fp.close()
...
def initialize():
	...
	for dir in dirs:
		dirname = os.path.join('/etc/nagios2/conf.univention.d', dir )
...
def clean():
	dirname='/etc/nagios2/conf.univention.d'
	if os.path.exists(dirname):
		listener.setuid(0)
		try:
			deleteTree(dirname)
