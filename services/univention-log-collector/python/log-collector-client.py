...
if __name__ == '__main__':
	...
	if 'logcollector/debug/level' in baseconfig:
		loglevel = baseconfig['logcollector/debug/level']

	loghost = ''
	if 'logcollector/loghost' in baseconfig:
		loghost = baseconfig['logcollector/loghost']
	elif 'ldap/master' in baseconfig:
	...
	parser.add_option(
		'-l', '--loghost', action='store', type='string',
		dest='host', default='',
