...
class soundFixedAttributes(univention.admin.syntax.select):
	...
	choices=[
		('univentionUpdate',_('Update Version')),
		]
...
childs=0
short_description=_('Policy: MailQuota')
policy_short_description=_('MailQuota')
long_description=''
options={
}
property_descriptions={
	...
	'requiredObjectClasses': univention.admin.property(
			short_description=_('Required ObjectClasses'),
			long_description='',
			syntax=univention.admin.syntax.string,
			multivalue=1,
			options=[],
	...
	'prohibitedObjectClasses': univention.admin.property(
			short_description=_('Prohibited ObjectClasses'),
			long_description='',
			syntax=univention.admin.syntax.string,
			multivalue=1,
			options=[],
