	...
	def configure(self, obj):
		...
		if obj.options.get('action','') == 'save':
			...
			if val == 'win2000':
				...
				univention.config_registry.handler_set( [ u'connector/ad/ldap/protocol=ldaps', u'connector/ad/ldap/port=636' ] )
			else:
				...
				if self.configRegistry.get('connector/ad/ldap/protocol', 'ldap') == 'ldaps':
					debugmsg( ud.ADMIN, ud.INFO, 'unsetting connector/ad/ldap/protocol' )
					univention.config_registry.handler_unset( [ u'connector/ad/ldap/protocol' ] )
