...
ad_mapping = {
	'user': univention.connector.property (
			...
			post_con_modify_functions=[ univention.connector.ad.password.password_sync_ucs_to_s4,
			...
			post_ucs_modify_functions=[ univention.connector.ad.password.password_sync_s4_to_ucs,
...
if baseConfig.has_key('connector/ad/mapping/group/language') and baseConfig['connector/ad/mapping/group/language'] in ['de','DE']:
	...
	'windowscomputer': univention.connector.property (
			...
			#post_con_create_functions = [ univention.connector.ad.computers.
