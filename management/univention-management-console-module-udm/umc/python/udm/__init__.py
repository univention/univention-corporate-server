...
from univention.management.console.modules.decorators import (
    Callback, SimpleThread, allow_get_request, file_upload, multi_response, prevent_xsrf_check, sanitize,
    simple_response, threaded,
)
...
class Instance(Base, ProgressMixin):
    ...
    def nav_object_query(self, request, ldap_connection=None, ldap_position=None):
        ...
        thread = SimpleThread('NavObjectQuery', Callback(_thread, request.options['container']), Callback(self.thread_finished_callback, request))
        thread.run()
