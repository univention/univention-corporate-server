...
define([
	...
	return declare("umc.modules.udm.DetailPage", [ ContainerWidget, StandbyMixin ], {
		...
		buildRendering: function() {
			...
			var forceReload = (anObjectIsBeingCreated && effectiveObjectDN) || this.moduleFlavor == 'recyclebin/deletedobject';
			this.propertyQuery = moduleCache.getProperties(this.objectType, effectiveObjectDN, forceReload);
			var forceLayoutReload = this.moduleFlavor == 'recyclebin/deletedobject';
