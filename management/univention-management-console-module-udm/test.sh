...
_curl -i "$base/users/user/properties"
_curl -i "$base/users/user/options"
_curl -i "$base/users/user/layout"
...
#_curl -i "$base/users/user/uid%3DAdministrator%2Ccn%3Dusers%2Cdc%3Dschool%2Cdc%3Dlocal/property"
_curl -i "$base/users/user/uid%3DAdministrator%2Ccn%3Dusers%2Cdc%3Dschool%2Cdc%3Dlocal/property/primaryGroup/choices"
