		...
		templateString: '' +
			'<div class="menuLoginHeader">' +
				'<div class="menuLoginHeader--loggedout" data-dojo-attach-point="loginWrapper">' +
					'<button class="ucsTextButton" data-dojo-type="umc/widgets/Button" data-dojo-attach-point="loginButon"></button>' +
				'</div>' +
				'<div class="menuLoginHeader--loggedin dijitDisplayNone" data-dojo-attach-point="loggedinWrapper">' +
					...
					'<div class="menuLoginHeader__innerWrapper">' +
						...
						'<button class="menuLoginHeader__logoutButton ucsTextButton" data-dojo-type="umc/widgets/Button" data-dojo-attach-point="logoutButon"></button>' +
					'</div>' +
				'</div>' +
			'</div>',
