	...
	return declare("_PortalIframe", [_WidgetBase, _DomTemplated], {
		...
		templateString: `
			<div class="portalIframe">
				<div
					class="portalIframe__loading"
					data-dojo-type="StandbyCircle"
					data-dojo-attach-point="loadingNode"
				></div>
				<span
