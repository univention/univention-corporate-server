	...
	const IframeTab = declare("_PortalIframeTab", [_WidgetBase, _DomTemplated, _CssStateMixin], {
		...
		templateString: `
			<div tabindex="0">
				...
				>
				<span class="iframeTab__title" data-dojo-attach-point="titleNode"></span>
				<button
					class="ucsIconButton iframeTab__closeButton"
		...
		updateTitleOverflow() {
			this.titleNode.title = this.titleNode.scrollWidth > this.titleNode.clientWidth
