...
The UMC server provides the possibility to defines categories used to
...
The each file can define several categories. For each of these
...
class XML_Definition( ET.ElementTree ):
	"""Represents an category definition."""
	...
	def priority( self ):
		...
		defined the default priority of -1 is returned. Noe is returned
