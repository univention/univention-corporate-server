...
class DBRegistry:
    ...
    def __create(cls):
        ...
        engine = create_engine(connection_uri, echo=True, pool_pre_ping=True)
        cls.__engine = engine
...
class PostgresListener:
    ...
    def verify_postgres(self, engine: Union[Engine, None] = None):
        if engine is None:
            engine = self.engine
    ...
    @classmethod
    def notify(cls, conn: Union[Connection, Session], session_id: str):
