...
See https://docs.software-univention.de/manual-4.2.html#domain:listenernotifier

## Listener module development

### Classic API

See https://docs.software-univention.de/developer-reference-4.2.html#chap:listener
