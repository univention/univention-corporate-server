...
See https://docs.software-univention.de/manual-4.4.html#domain:listenernotifier

## Listener module development

### Classic API

See https://docs.software-univention.de/developer-reference-4.4.html#chap:listener
