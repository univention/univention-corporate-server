...
dojo.provide("umc.modules._upater.DetailsPage");

dojo.require("umc.i18n");
dojo.require("umc.dialog");

dojo.require("umc.modules._upater.Page");
dojo.require("umc.modules._upater.Form");

dojo.declare("umc.modules._upater.DetailsPage", umc.modules._upater.Page, {
	
	i18nClass: 		'umc.modules.upater',
    ...
    buildRendering: function() {
    	...
    	this._form = new umc.modules._upater.Form({
    		widgets:		widgets,
    		layout:			layout,
    		//buttons:		buttons,
