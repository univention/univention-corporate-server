...
#  admin policy for the autostart settings
#
...
layout=[
	univention.admin.tab(_('General'),_('Autostart'), [
		[univention.admin.field('name', hide_in_resultmode=1) ],
		[univention.admin.field('autostartScript') ]
	]),
...
mapping.register('autostartScript', 'univentionAutoStartScript', None, univention.admin.mapping.ListToString)
...
def identify(dn, attr, canonical=0):
	return 'univentionPolicyAutoStart' in attr.get('objectClass', [])
