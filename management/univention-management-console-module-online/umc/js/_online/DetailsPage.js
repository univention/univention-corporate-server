...
dojo.provide("umc.modules._online.DetailsPage");
...
dojo.declare("umc.modules._online.DetailsPage", umc.modules._online.Page, {
    ...
    buildRendering: function() {
    	...
    	this._form = new umc.modules._online.Form({
    		widgets:		widgets,
    		layout:			layout,
    		//buttons:		buttons,
