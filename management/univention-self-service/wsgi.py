...
for plugin in plugins:
	...
	cherrypy.log("wsgi: started serving plugin '{}' at '{}'.".format(plugin.name, URL_ROOT + plugin.url))
	cherrypy.log("wsgi: plugin '{}' provided conf '{}'.".format(plugin.name, plugin.cherrypy_conf))
