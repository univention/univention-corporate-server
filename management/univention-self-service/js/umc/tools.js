...
define([
	...
	"umc/i18n/tools",
	"umc/i18n!"
], function(lang, array, _window, xhr, basexhr, Deferred, json, string, topic, cookie, Dialog, TitlePane, timing, styles, entities, auth, ContainerWidget, ConfirmDialog, Text, i18nTools, _) {
