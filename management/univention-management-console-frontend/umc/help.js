...
dojo.mixin(umc.help, new umc.i18n.Mixin({
	...
	show: function() {
		...
		var message = dojo.replace( '<p>{introduction}</p> \
<p><b>{titleDoc}:</b> \
<ul> \
	<li><a href="http://www.univention.de/fileadmin/download/dokumentation_2.4/handbuch_ucs24.pdf" target="_blank">{manual}</a></li> \
	<li><a href="http://www.univention.de/download_doku.html" target="_blank">{add_doc}</a></li> \
</ul></p> \
<p><b>{titleSup}:</b> \
<ul> \
...
<ul> \
	...
	<li><a href="http://www.univention.de/en/about-univention/contact/" target="_blank">{support}</a></li> \
</ul></p>', {
	...
	titleAss : this._( 'Support and assistance' )
		...
		umc.dialog.alert( message, this._( 'Help' ), this._( 'Close' ) );
	}
} );