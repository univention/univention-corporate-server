...
define([
	...
	return {
		...
		widgets: [{
			type: Text,
			name: 'text',
			content: _('<p>The startup wizard has been completed now.</p><p>All listed information can be accessed at any later point in time via the application menu on the top right.</p>')
		}]
	};
});
