...
class Object(ConditionalResource, FormBase, _OpenAPIBase, Resource):
    ...
    async def get(
        ...
        if module.name == 'recyclebin/deletedobject':
...
class ObjectRestore(Resource):
    ...
    async def post(self, object_type, dn):
        ...
        if 'restore' not in module.operations:
            raise HTTPError(405, _('Restore operation not supported for %s') % object_type)
        ...
        # Build URI with the correct object type (not recyclebin/deletedobject)
