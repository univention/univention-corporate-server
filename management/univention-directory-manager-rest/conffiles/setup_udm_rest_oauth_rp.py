...
def handler(config_registry, changes):
    ...
    handler_set([
        ...
        'directory/manager/rest/oauth/openid-configuration=/usr/share/univention-directory-manager-rest/oauth/%s.json' % (safe_filename),
        'directory/manager/rest/oauth/openid-certs=/usr/share/univention-directory-manager-rest/oauth/%s.jwks' % (safe_filename),
    ])
