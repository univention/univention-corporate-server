...
property_descriptions = {
	...
	'notificationOptionWarning': univention.admin.property(
		...
		long_description=_('Send notification when the service state changes to WARNING'),
		syntax=univention.admin.syntax.boolean,
		default='1',
	),
	'notificationOptionCritical': univention.admin.property(
		short_description=_('Notify if service state changes to CRITICAL'),
		long_description=_('Send notification when the service state changes to CRITICAL'),
		syntax=univention.admin.syntax.boolean,
		default='1',
	),
	'notificationOptionUnreachable': univention.admin.property(
		...
		long_description=_('Send notification when the service state changes to UNREACHABLE'),
		syntax=univention.admin.syntax.boolean,
		default='1',
	),
	'notificationOptionRecovered': univention.admin.property(
		short_description=_('Notify if service state changes to RECOVERED'),
		long_description=_('Send notification when the service state changes to RECOVERED'),
		syntax=univention.admin.syntax.boolean,
		default='1',
	),
