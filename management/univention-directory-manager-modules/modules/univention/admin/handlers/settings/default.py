...
property_descriptions = {
	...
	'defaultGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all new users get added'),
	...
	'defaultComputerGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all new computers get added'),
		syntax=univention.admin.syntax.GroupDN,
		include_in_default_search=True,
		required=True,
	),
	'defaultDomainControllerGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all new DC Slaves get added'),
		syntax=univention.admin.syntax.GroupDN,
		include_in_default_search=True,
		required=True,
	),
	'defaultDomainControllerMBGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all new DC Backups get added'),
		syntax=univention.admin.syntax.GroupDN,
		include_in_default_search=True,
		required=True,
	),
	'defaultMemberServerGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all new Member servers get added'),
		syntax=univention.admin.syntax.GroupDN,
		include_in_default_search=True,
		required=True,
	),
	'defaultClientGroup': univention.admin.property(
		...
		long_description=_('Name of the group, to which all client computers get added'),
		syntax=univention.admin.syntax.GroupDN,
		include_in_default_search=True,
		required=True,
	),
	'defaultKdeProfiles': univention.admin.property(
		...
		long_description=_('Name of the KDE profile, which is used for all new users by default'),
		syntax=univention.admin.syntax.string,
		multivalue=True,
	),
}
