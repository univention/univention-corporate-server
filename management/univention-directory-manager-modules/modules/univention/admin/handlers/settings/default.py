...
property_descriptions = {
	...
	'defaultDomainControllerGroup': univention.admin.property(
		short_description=_('Default Replica Directory Node Computer Group'),
		long_description='',
		syntax=univention.admin.syntax.GroupDN,
		dontsearch=True,
		required=True,
	...
	'defaultDomainControllerMBGroup': univention.admin.property(
		short_description=_('Default Primary and Backup Directory Node Server Group'),
		long_description='',
		syntax=univention.admin.syntax.GroupDN,
		dontsearch=True,
		required=True,
	...
	'defaultMemberServerGroup': univention.admin.property(
		short_description=_('Default Managed Node Group'),
		long_description='',
		syntax=univention.admin.syntax.GroupDN,
		dontsearch=True,
		required=True,
