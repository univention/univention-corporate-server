...
property_descriptions = {
	...
	'policies': univention.admin.property(
		...
		long_description=_('List of LDAP containers used as standard containers. They can be selected when a new UDM object is created. They allow you to put newly created objects in them.'),
