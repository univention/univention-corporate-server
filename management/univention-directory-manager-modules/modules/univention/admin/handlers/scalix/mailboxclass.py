...
#  admin module for scalix mailbox classes
#
...
childs=0
short_description=_('Scalix: Mailbox Classes')
long_description=''

module_search_filter=univention.admin.filter.conjunction('&', [
	univention.admin.filter.expression('objectClass', 'univentionScalixMailboxClass'),
	])
...
class object(univention.admin.handlers.simpleLdap):
	...
	def _ldap_addlist(self):
		ocs=[]
		al=[]
		ocs.append('univentionScalixMailboxClass')
...
def identify(dn, attr, canonical=0):
	return 'univentionScalixMailboxClass' in attr.get('objectClass', [])
