...
operations = ['search']
childmodules = ['authorization/policy', 'authorization/privilege', 'authorization/comparison']
virtual = True
...
def identify(dn: str, attr: univention.admin.handlers._Attributes, canonical: bool = False) -> False:
    return False
