...
property_descriptions = {
	...
	'policyPath': univention.admin.property(
		...
		long_description=_('Standard containers can be selected when a new UDM object is created. They allow you to put newly created objects in this container.'),
	...
	'description': univention.admin.property(
		...
		long_description=_('Some descriptive text for this container'),
		syntax=univention.admin.syntax.string,
		include_in_default_search=True,
		readonly_when_synced=True,
	),
