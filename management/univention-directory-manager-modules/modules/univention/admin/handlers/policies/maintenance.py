...
property_descriptions = {
	...
	'startup': univention.admin.property(
		...
		long_description=_('Perform package maintenance and/or errata/release updates each time the host powers on'),
		syntax=univention.admin.syntax.boolean,
	),
	'shutdown': univention.admin.property(
		short_description=_('Perform maintenance before system shutdown'),
		long_description=_('Perform package maintenance and/or errata/release updates each time the host powers off'),
		syntax=univention.admin.syntax.boolean,
	),
	'reboot': univention.admin.property(
		short_description=_('Reboot after maintenance'),
		long_description=_('Automatically reboot the hosts after package maintenance and/or errata/release updates have been performed'),
		syntax=univention.admin.syntax.timeSpec,
	),
	'cron': univention.admin.property(
		short_description=_('Use Cron settings'),
		long_description=_('Perform package maintenance and/or errata/release updates based on time schedule'),
		syntax=univention.admin.syntax.boolean,
	),
