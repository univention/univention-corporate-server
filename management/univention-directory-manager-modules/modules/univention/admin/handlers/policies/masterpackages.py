...
childs = 0
short_description = _('Policy: Master/Backups packages')
object_name = _('Master/Backups packages policy')
object_name_plural = _('Master/Backups packages policies')
policy_short_description = _('Master/Backup packages')
long_description = ''
options = {
