...
childs = 0
short_description = _('Policy: Slaves packages')
object_name = _('Slaves packages policy')
object_name_plural = _('Slaves packages policies')
policy_short_description = _('Slaves packages')
long_description = ''
options = {
