...
class AttributeHook(simpleHook):
	...
	def hook_open(self, obj):
		...
		:param obj: The |UDM| object instance.
		"""
		assert isinstance(self.udm_attribute_name, basestring if six.PY2 else str), "udm_attribute_name has to be a str"  # noqa: F821
	...
	def hook_ldap_modlist(self, obj, ml):
		...
		"""
		assert isinstance(self.ldap_attribute_name, basestring if six.PY2 else str), "ldap_attribute_name has to be a str"  # noqa: F821
		new_ml = []
		for ml_value in ml:
			if len(ml_value) == 2:
