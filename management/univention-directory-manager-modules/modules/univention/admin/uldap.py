...
def getAdminConnection(start_tls=2, decode_ignorelist=None):
    # type: (int, None) -> Tuple[univention.admin.uldap.access, univention.admin.uldap.position]
    """
...
def getMachineConnection(start_tls=2, decode_ignorelist=None, ldap_master=True):
    # type: (int, None, bool) -> Tuple[univention.admin.uldap.access, univention.admin.uldap.position]
    """
