...
def _get_attrs_from_permissions(module_name: str, permissions: dict) -> (list[str], list[str], list[str]):
    ...
    readable_attributes = [attr for attr in attributes if attributes[attr].get('access', None) == 'read']
    writable_attributes = [attr for attr in attributes if attributes[attr].get('access', None) == 'write']
    none_attributes = [attr for attr in attributes if attributes[attr].get('access', None) == 'none']
