...
BUILTIN_OIDS = [
    ...
    # new OIDs in official OpenLDAP 2.5 OID space (UCS 5.2)
    '1.3.6.1.4.1.4203.666.11.1.3.2.0.21',  # olcDisabled
    '1.3.6.1.4.1.4203.666.11.1.3.0.94',  # olcIndexHash64
    '1.3.6.1.4.1.4203.666.11.1.3.2.0.22',  # olcLastBind
    '1.3.6.1.4.1.4203.666.11.1.3.0.101',  # olcMaxFilterDepth
    '1.3.6.1.4.1.4203.666.11.1.3.0.91',  # olcSaslAuxpropsDontUseCopy
    '1.3.6.1.4.1.4203.666.11.1.3.0.92',  # olcSaslAuxpropsDontUseCopyIgnore
    '1.3.6.1.4.1.4203.666.11.1.3.0.100',  # olcSaslCBinding
    '1.3.6.1.4.1.4203.666.11.1.3.0.95',  # olcThreadQueues
    '1.3.6.1.4.1.4203.666.11.1.3.0.97',  # olcTLSCACertificate
    '1.3.6.1.4.1.4203.666.11.1.3.0.98',  # olcTLSCertificate
    '1.3.6.1.4.1.4203.666.11.1.3.0.99',  # olcTLSCertificateKey
    '1.3.6.1.4.1.4203.666.11.1.3.0.96',  # olcTLSECName
    '1.3.6.1.4.1.4203.666.11.1.3.1.12.1',  # olcBkMdbIdlExp
    '1.3.6.1.4.1.4203.666.11.1.3.2.12.4',  # olcDbMaxEntrySize
    '1.3.6.1.4.1.4203.666.11.1.3.2.12.6',  # olcDbMultival
    '1.3.6.1.4.1.4203.666.11.1.3.2.12.5',  # olcDbRtxnSize
    '1.3.6.1.4.1.4203.666.11.1.3.4.1.1',  # olcSmbK5PwdEnable
    '1.3.6.1.4.1.4203.666.11.1.3.4.1.2',  # olcSmbK5PwdMustChange
    '1.3.6.1.4.1.4203.666.11.1.3.4.1.3',  # olcSmbK5PwdCanChange
    '1.3.6.1.4.1.4203.666.11.1.3.4.2.1',  # olcPwdsKinitEnable
    '1.3.6.1.4.1.4203.666.11.1.3.3.11.1',  # olcRefintAttribute
    '1.3.6.1.4.1.4203.666.11.1.3.3.11.2',  # olcRefintNothing
    '1.3.6.1.4.1.4203.666.11.1.3.3.11.3',  # olcRefintModifiersName
    '1.3.6.1.4.1.4203.666.11.1.3.3.13.1',  # olcConstraintAttribute
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.1',  # olcAccessLogDB
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.2',  # olcAccessLogOps
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.3',  # olcAccessLogPurge
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.4',  # olcAccessLogSuccess
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.5',  # olcAccessLogOld
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.6',  # olcAccessLogOldAttr
    '1.3.6.1.4.1.4203.666.11.1.3.3.4.7',  # olcAccessLogBase
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.0',  # olcMemberOfDN
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.1',  # olcMemberOfDangling
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.2',  # olcMemberOfRefInt
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.3',  # olcMemberOfGroupOC
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.4',  # olcMemberOfMemberAD
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.5',  # olcMemberOfMemberOfAD
    '1.3.6.1.4.1.4203.666.11.1.3.3.18.7',  # olcMemberOfDanglingError
    '1.3.6.1.4.1.4203.666.11.1.4.2.4.1',  # olcMonitorConfig
    '1.3.6.1.4.1.4203.666.11.1.4.1.12.1',  # olcMdbBkConfig
    '1.3.6.1.4.1.4203.666.11.1.4.4.1.1',  # olcSmbK5PwdConfig
    '1.3.6.1.4.1.4203.666.11.1.4.4.2.1',  # olcPwdsKinitConfig
    '1.3.6.1.4.1.4203.666.11.1.4.3.11.1',  # olcRefintConfig
    '1.3.6.1.4.1.4203.666.11.1.4.3.13.1',  # olcConstraintConfig
    '1.3.6.1.4.1.4203.666.11.1.4.3.4.1',  # olcAccessLogConfig
    '1.3.6.1.4.1.4203.666.11.1.4.3.18.1',  # olcMemberOfConfig / olcMemberOf
    # not sure?
    '1.3.6.1.4.1.42.2.27.8.1.27',  # pwdStartTime
    '1.3.6.1.4.1.42.2.27.8.1.28',  # pwdEndTime
    ...
    '1.3.6.1.4.1.42.2.27.8.1.24',  # pwdMinDelay
    '1.3.6.1.4.1.42.2.27.8.1.25',  # pwdMaxDelay
    '1.3.6.1.4.1.42.2.27.8.1.26',  # pwdMaxIdle
    '1.3.6.1.4.1.42.2.27.8.1.32',  # pwdMaxRecordedFailure
    '1.3.6.1.4.1.4754.1.99.1',  # pwdCheckModule
    '1.3.6.1.4.1.4754.1.99.2',  # pwdCheckModuleArg
    '1.3.6.1.4.1.4754.2.99.1',  # pwdPolicyChecker
    '1.3.6.1.4.1.42.2.27.8.2.1',  # pwdPolicy
    '1.3.6.1.4.1.4203.666.1.60',  # pKCS8PrivateKey
    '1.3.6.1.4.1.42.2.27.8.1.29',  # pwdLastSuccess
    '1.3.6.1.4.1.4203.666.11.5.1.1',  # reqDN
    '1.3.6.1.4.1.4203.666.11.5.1.2',  # reqStart
    '1.3.6.1.4.1.4203.666.11.5.1.3',  # reqEnd
    '1.3.6.1.4.1.4203.666.11.5.1.4',  # reqType
    '1.3.6.1.4.1.4203.666.11.5.1.5',  # reqSession
    '1.3.6.1.4.1.4203.666.11.5.1.6',  # reqAuthzID
    '1.3.6.1.4.1.4203.666.11.5.1.7',  # reqResult
    '1.3.6.1.4.1.4203.666.11.5.1.8',  # reqMessage
    '1.3.6.1.4.1.4203.666.11.5.1.9',  # reqReferral
    '1.3.6.1.4.1.4203.666.11.5.1.10',  # reqControls
    '1.3.6.1.4.1.4203.666.11.5.1.11',  # reqRespControls
    '1.3.6.1.4.1.4203.666.11.5.1.12',  # reqId
    '1.3.6.1.4.1.4203.666.11.5.1.13',  # reqVersion
    '1.3.6.1.4.1.4203.666.11.5.1.14',  # reqMethod
    '1.3.6.1.4.1.4203.666.11.5.1.15',  # reqAssertion
    '1.3.6.1.4.1.4203.666.11.5.1.16',  # reqMod
    '1.3.6.1.4.1.4203.666.11.5.1.17',  # reqOld
    '1.3.6.1.4.1.4203.666.11.5.1.18',  # reqNewRDN
    '1.3.6.1.4.1.4203.666.11.5.1.19',  # reqDeleteOldRDN
    '1.3.6.1.4.1.4203.666.11.5.1.20',  # reqNewSuperior
    '1.3.6.1.4.1.4203.666.11.5.1.21',  # reqScope
    '1.3.6.1.4.1.4203.666.11.5.1.22',  # reqDerefAliases
    '1.3.6.1.4.1.4203.666.11.5.1.23',  # reqAttrsOnly
    '1.3.6.1.4.1.4203.666.11.5.1.24',  # reqFilter
    '1.3.6.1.4.1.4203.666.11.5.1.25',  # reqAttr
    '1.3.6.1.4.1.4203.666.11.5.1.26',  # reqSizeLimit
    '1.3.6.1.4.1.4203.666.11.5.1.27',  # reqTimeLimit
    '1.3.6.1.4.1.4203.666.11.5.1.28',  # reqEntries
    '1.3.6.1.4.1.4203.666.11.5.1.29',  # reqData
    '1.3.6.1.4.1.4203.666.11.5.1.31',  # reqEntryUUID
    '1.3.6.1.4.1.4203.666.11.5.1.33',  # reqNewDN
    '1.3.6.1.4.1.4203.666.11.5.2.0',  # auditContainer
    '1.3.6.1.4.1.4203.666.11.5.2.1',  # auditObject
    '1.3.6.1.4.1.4203.666.11.5.2.2',  # auditReadObject
    '1.3.6.1.4.1.4203.666.11.5.2.3',  # auditWriteObject
    '1.3.6.1.4.1.4203.666.11.5.2.4',  # auditAbandon
    '1.3.6.1.4.1.4203.666.11.5.2.5',  # auditAdd
    '1.3.6.1.4.1.4203.666.11.5.2.6',  # auditBind
    '1.3.6.1.4.1.4203.666.11.5.2.7',  # auditCompare
    '1.3.6.1.4.1.4203.666.11.5.2.8',  # auditDelete
    '1.3.6.1.4.1.4203.666.11.5.2.9',  # auditModify
    '1.3.6.1.4.1.4203.666.11.5.2.10',  # auditModRDN
    '1.3.6.1.4.1.4203.666.11.5.2.11',  # auditSearch
    '1.3.6.1.4.1.4203.666.11.5.2.12',  # auditExtended
    '1.3.6.1.4.1.4203.666.11.5.1.30',  # auditContext
    '1.3.6.1.4.1.4203.666.11.5.1.32',  # minCSN
]
