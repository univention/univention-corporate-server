...
EXCLUDE_ATTRIBUTES=['subschemaSubentry', 'hasSubordinates', 'entryDN', 'MEMBEROF', 'PWDCHANGEDTIME', 'PWDACCOUNTLOCKEDTIME', 'PWDFAILURETIME', 'PWDHISTORY', 'PWDGRACEUSETIME', 'PWDRESET', 'PWDPOLICYSUBENTRY']
