...
export exclude="lilo,pcmcia-cs,base-config,exim,mailx,at,logrotate,cpio,ipchains,dhcp-client,manpages,modconf,mbr,man-db,makedev,telnet,libdb4.0,info,diff,syslinux,libpcre3-udeb,udev-udeb,libc6-udeb,rsyslog"
