...
\begin{itemize}
\item Crashs of \ucsName{UMC} server and modules will now be logged (\ucsBug{31130}).
\end{itemize}
...
\begin{itemize}
\item Spaces are no longer allowed in the username (this can be overwritten
with the \ucsUCRV{directory/manager/web/modules/users/user/properties/username/syntax},
\ucsBug{19441}).
