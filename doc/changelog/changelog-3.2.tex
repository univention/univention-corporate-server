...
\item The description for an obsolete \ucsUCRV{} has been removed
(\ucsBug{24715}).
...
software repository (\ucsBug{31562}, \ucsBug{30888}):
{\small \ucsName{libdbd-mysql}, \ucsName{libjs-jquery}, \ucsName{duplicity}, \ucsName{librsync}}
