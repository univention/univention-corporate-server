...
\item Added in \ucsName{univention-printserver} ErrorPolicy to the cups template. ErrorPolicy can be set over ucr varibale \ucsUCRV{cups/errorpolicy}. The change will be applied to all printers. (\ucsBug{28877}).
