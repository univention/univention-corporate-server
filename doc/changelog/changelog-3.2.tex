...
\item \ucsName{univention-mail-cyrus} has been modified. UCR variable
...
\item Added in \ucsName{univention-printserver} ErrorPolicy to the cups template. ErrorPolicy can be set over ucr variable \ucsUCRV{cups/errorpolicy}. The change will be applied to all printers. (\ucsBug{28877}).
...
The robustness against DRS replication delays has been improved in some tests (\ucsBug{28343}, \ucsBug{28348}).
