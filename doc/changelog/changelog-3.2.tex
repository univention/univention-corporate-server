...
\emph{mail/cyrus/bdb/dbconfig/set\_lg\_regionmax=2097152} and
\emph{mail/cyrus/bdb/dbconfig/set\_cachesize=0 2097152 1} (\ucsBug{28464}).
...
\item Fixed file permissions of \ucsFile{/var/lib/samba/ntp_signd} (\ucsBug{31109}).
\end{itemize}
