...
% special notes
\newcommand{\ucsNote}[2][Attention:]{\textsl{\textbf{#1}\ifthenelse{\equal{#1}{}}{}{\\}#2}}

% extra note
\newcommand{\ucsAttention}[1]{\textbf{Attention:}\\#1}

% example
\newcommand{\ucsExample}[2][Example:]{\textbf{#1}\\#2}
...
\newcommand{\ucsGraphicsTabbox}[3][1]
 {
  \begin{center}
   ...
   {\refstepcounter{figure}Illustration \thefigure: \begin{minipage}[t]{0.7\textwidth}{#2}\end{minipage}}
  \end{center}
 }
...
\newcommand{\ucsUMS}[1]{UCS management system#1}
...
\newcommand{\ucsMaster}{master domain controller}
\newcommand{\ucsBackup}{backup domain controller}
\newcommand{\ucsSlave}{slave domain controller}
\newcommand{\ucsMember}{member server}

%\newcommand{\ucsUCRV}[1]{Univention Configuration Registry variable #1}

\newcommand{\ucsUCS}[1]{Univention Corporate Server#1}

\newcommand{\ucsUGS}[1]{Univention Groupware Server#1}
\newcommand{\ucsKolab}[1]{Kolab2 for UCS#1}
