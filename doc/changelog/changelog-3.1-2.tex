...
\section{LDAP}
\begin{itemize}
\item \ucsName{univention-ldap}. The functionless ucr-variable 'ldap/server/additional' removed. Use ldap/server/addition (\ucsBug{24507}).
