...
\item The unused UCR variables \ucsUCRV{samba/client_use_spnego} and \ucsUCRV{samba/time_server} has been removed (\ucsBug{26389}).
\end{itemize}
...
\section{base}
\begin{itemize}
\item \ucsName{univention-lib}. base.sh file: function call_joinscript() has been modified. The start and end of  every executed joinscript will be displayed on console. Assist for a better tracing (\ucsBug{29263}).
