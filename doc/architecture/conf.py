...
intersphinx_mapping = {
    ...
    "uv-developer-reference": ("https://docs.software-univention.de/developer-reference/5.1/en", None),
    "uv-app-center": ("https://docs.software-univention.de/app-center/5.1/en", None),
