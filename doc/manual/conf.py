...
intersphinx_mapping = {
    "uv-dev-ref": ("https://docs.software-univention.de/developer-reference/5.0/en", ("../developer-reference/_build/en/html/objects.inv", "../developer-reference/_build/html/objects.inv", None)),
