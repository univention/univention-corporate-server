...
the installation, :external+uv-ucs-operation:ref:`management-interface-license-activate`
...
.. code-block::
   ...
   $ ./univention-appcenter-control new-version 5.3/myapp
   ...
   $ ./univention-appcenter-control get --json 5.3/myapp |
     jq '._ini_vars.SupportedUCSVersions'

   # creates version 2.0 of myapp based on the (formerly) latest version
   $ ./univention-appcenter-control new-version 5.3/myapp 5.3/myapp=2.0

   # sets the DockerImage of the new app
   $ ./univention-appcenter-control set 5.3/myapp=2.0 \
     --json '{"DockerImage": "mycompany/myimage:2.0"}'

   # copies myapp Version 1.0 from UCS 4.4 to UCS 5.3.
   $ ./univention-appcenter-control new-version 4.4/myapp=1.0 5.3/myapp=1.0

   # uploads all README files in the current folder to the latest version
   # myapp in UCS 4.2
   $ ./univention-appcenter-control upload 5.3/myapp README*
   ...
   $ ./univention-appcenter-control upload 5.3/myapp=1.0 myapp.svg
