...
at <https://docs.software-univention.de/app-provider-5.3.html>. The
...
In the document's root directory is the file `app-provider-5.3.html`,
...
2. The reader accesses the documentation with an anchor link to a
   ...
   <https://docs.software-univention.de/app-provider-5.3.html#testing:test-app-center>.
   The redirect map detects the hash part of the link and redirects the
   reader's browser to the new location
   <https://docs.software-univention.de/app-center/5.3/en/lifecycle.html#testing-test-app-center>
   directly and immediately.

The redirect map is not automatically copied to the docs.univention.de
repository by the build pipeline. Changes to `app-provider-5.3.html`
