...
.. code-block::
   ...
   d-i mirror/codename string ucs506
   d-i mirror/suite string uc504
   d-i mirror/udeb/suite string ucs506
...
`<http://updates.software-univention.de/pxe/5.0-6/amd64/gtk/debian-installer/amd64/>`_:
...
#. Configure the boot loader to load the Linux kernel and initial ram disk from
   ...
   .. code-block:: console
      ...
      $ PXE='http://updates.software-univention.de/pxe'
      $ PXE="$PXE/5.0-6/amd64/gtk/debian-installer/amd64"
      $ ucr set \
