...
.. code-block::
   ...
   d-i mirror/codename string ucs508
   d-i mirror/suite string uc507
   d-i mirror/udeb/suite string ucs508
...
`<http://updates.software-univention.de/pxe/5.0-8/amd64/gtk/debian-installer/amd64/>`_:
...
#. Configure the boot loader to load the Linux kernel and initial ram disk from
   ...
   .. code-block:: console
      ...
      $ PXE='http://updates.software-univention.de/pxe'
      $ PXE="$PXE/5.0-8/amd64/gtk/debian-installer/amd64"
      $ ucr set \
