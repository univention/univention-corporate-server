...
Subscription credentials
   A name and a random password generated by the ``subscribe`` subcommand of the CLI tool
...
The ``subscribe`` subcommand registers a new subscription with the Provisioning API.
...
The ``unsubscribe`` subcommand removes an existing subscription from the Provisioning API.
