...
empty or unset or ``current``
   ...
   If for example UCS 5.2 is currently installed. When UCS 5.3 or UCS 6.0 become
...
*major.minor*
   ...
   For example ``5.2 5.3`` would only include the component with UCS 5.2 and 5.3
   but not if UCS 5.0 or UCS 5.1 is in use.
