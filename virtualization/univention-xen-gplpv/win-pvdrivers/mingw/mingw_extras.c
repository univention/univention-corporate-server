/*
 * Provide missing std functions needed by the driver but not provided by
 * MinGW. Code mostly taken from Linux or as noted.
 *
 * Remaining code is
 * Copyright Andy Grover <andy.grover@oracle.com> 
...
/* from arch/x86/boot/string.c, used under GPLv2 */
...
/* from arch/x86/boot/boot.h, used under GPLv2 */
/* Copyright (C) 1991, 1992 Linus Torvalds
 * Copyright 2007 rPath, Inc. - All Rights Reserved
 */
