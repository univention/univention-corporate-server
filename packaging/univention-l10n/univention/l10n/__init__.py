...
from .l10n import (
    ...
    NoSpecialCaseDefintionsFound, SpecialCase, UMCModuleTranslation, create_new_package,
    find_base_translation_modules, get_special_cases_from_checkout, get_special_cases_from_srcpkg,
    message_catalogs, read_special_case_definition, sourcefileprocessing, template_file,
    translate_special_case, update_package_translation_files, write_makefile,
)
