...
class EnglishMasterInstaller(Installer):
	...
	def set_country_and_keyboard_layout(self):
		...
		self.client.saveScreenshot('installer-location_en.png')
		self.client.keyPress('enter')
		...
		self.client.saveScreenshot('installer-keyboardselection_en.png')
	...
	def network_setup(self):
		...
		self.client.saveScreenshot('installer-netcfg-dhcp_en.png')
		...
		self.client.saveScreenshot('installer-netcfg-static_en.png')
		self.client.keyPress('enter')
		self.client.waitForText(self.locale_strings['ip_address'], timeout=30)
		self.client.enterText(self.vm_config.ip)
		self.client.saveScreenshot('installer-netcfg-ip_en.png')
		self.client.keyPress('enter')
	...
	def account_setup(self):
		...
		self.client.enterText(self.vm_config.password)
		self.client.saveScreenshot('installer-password_en.png')
		self.client.keyPress('enter')
	...
	def hdd_setup(self, hdd_empty=True):
		...
		self.client.saveScreenshot('installer-partman-selectguided_en.png')
		self.client.keyPress('enter')
		...
		time.sleep(2)
		self.client.saveScreenshot('installer-partman-writelvm_en.png')
		self.client.keyPress('enter')
	...
	def setup_ucs_master(self):
		...
		self.client.saveScreenshot('installer-domainrole_en.png')
		...
		self.client.saveScreenshot('installer-hostname_en.png')
		...
		self.client.saveScreenshot('installer-softwareselection_en.png')
		self.client.mouseClickOnText(self.locale_strings['next'])
		self.client.waitForText(self.locale_strings['confirm_config'], timeout=30)
		self.client.saveScreenshot('installer-overview_en.png')
