...
basic_setup () {
	...
	[ $(ucr get version/version) = "5.0" ] && echo -e "deb [trusted=yes] http://omar.knut.univention.de/build2/ ucs_5.0-0-ucs5samba/all/" >> /etc/apt/sources.list
	[ $(ucr get version/version) = "5.0" ] && echo -e "deb [trusted=yes] http://omar.knut.univention.de/build2/ ucs_5.0-0-ucs5samba/\$(ARCH)/" >> /etc/apt/sources.list
...
jenkins_updates () {
	...
	[ $(ucr get version/version) = "4.4" ] && echo -e "deb [trusted=yes] http://omar.knut.univention.de/build2/ ucs_5.0-0-ucs5samba/all/" >> /etc/apt/sources.list
	[ $(ucr get version/version) = "4.4" ] && echo -e "deb [trusted=yes] http://omar.knut.univention.de/build2/ ucs_5.0-0-ucs5samba/\$(ARCH)/" >> /etc/apt/sources.list
