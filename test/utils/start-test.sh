...
# AMI: Univention Corporate Server (UCS) 5.0 (official image) rev.1
current_ami=ami-0be22e1965991d8b9
# AMI: Univention Corporate Server (UCS) 4.4 (official image) rev. 9
