...
release='5.0-9'  #
export CURRENT_AMI="${CURRENT_AMI:=ami-0d29832308bf979df}"  # AMI: Univention Corporate Server (UCS) 5.0 (official image) rev. 10
old_release='4.4-9'  #
...
export OPENSTACK_IMAGE_VERSION="${OPENSTACK_IMAGE_NAME:=5.0-8}"  # version for the openstack image
