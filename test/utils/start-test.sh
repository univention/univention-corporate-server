...
release='5.0-6'  #
export CURRENT_AMI="${CURRENT_AMI:=ami-09fefd41ed2cea5a4}"  # AMI: Univention Corporate Server (UCS) 5.0 (official image) rev. 7
old_release='4.4-9'  #
export OLD_AMI="${OLD_AMI:=ami-02ad9aab36aadf18a}"  # AMI: Univention Corporate Server (UCS) 4.4 (official image) rev. 11
export KVM_UCSVERSION="${KVM_UCSVERSION:=5.0-6+e897}"  #
export OPENSTACK_IMAGE_NAME="${OPENSTACK_IMAGE_NAME:=UCS 5.0-6}"  #
