...
release='5.0-7'
old_release='4.4-9'
kvm_template_version='5.0-7+e993'
openstack_image_name='UCS 5.0-7'
# AMI: Univention Corporate Server (UCS) 5.0 (official image) rev. 8
current_ami=ami-068c5ee1a47ec4429
