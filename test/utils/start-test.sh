...
release='5.0-10'  #
export CURRENT_AMI="${CURRENT_AMI:=ami-00c198b3f9bb2c1ba}"  # AMI: Univention Corporate Server (UCS) 5.0 (official image) rev. 11
old_release='4.4-9'  #
export OLD_AMI="${OLD_AMI:=ami-02ad9aab36aadf18a}"  # AMI: Univention Corporate Server (UCS) 4.4 (official image) rev. 11
export KVM_UCSVERSION="${KVM_UCSVERSION:=5.0-10+e1220}"  #
export OPENSTACK_IMAGE_VERSION="${OPENSTACK_IMAGE_VERSION:=5.0-10}"  # version for the openstack image
