...
old_release='4.4-9'  #
export OLD_AMI="${OLD_AMI:ami-068c5ee1a47ec4429a}"  # AMI: Univention Corporate Server (UCS) 5.0 (official image) rev. 8
export KVM_UCSVERSION="${KVM_UCSVERSION:=5.1-0+2024}"  #
export OPENSTACK_IMAGE_NAME="${OPENSTACK_IMAGE_NAME:=UCS 5.1-0}"  #
