...
_ec2_image () {
	...
	_ssh -l "$KVM_USER" "${IMAGE_SERVER}" "generate_appliance --only --ec2-ebs -s /tmp/master-ec2-appliance/master.qcow2 -v '${UCS_VERSION_INFO}' --vendor-url 'At least 2GB of RAM are required. https://www.univention.com/'"
}
