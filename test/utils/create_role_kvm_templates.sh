...
# create the machines
./utils/start-test.sh scenarios/appliances/role-kvm-templates.cfg


templatedir="/mnt/omar/vmwares/kvm/single/Others"
tmpdir="/mnt/omar/vmwares/kvm/tmp/role-templates"
...
cleanup () {
	for role in master backup slave member; do
		local instance="${KVM_USER}_${role}-role-templates"
