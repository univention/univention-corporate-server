...
write_slave1_preseed () {
	cat > /var/lib/univention-client-boot/preseed/slave1_preseed <<- _EOF_
		...
		d-i pkgsel/include string univention-system-setup-boot univention-management-console-web-server univention-management-console-module-setup linux-image-amd64 openssh-server
