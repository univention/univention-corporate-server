...
write_slave1_preseed () {
	cat > /var/lib/univention-client-boot/preseed/slave1_preseed <<- _EOF_
		...
		d-i mirror/http/directory string /univention-repository/4.3/maintained/4.3-0
		# Package archives
		d-i mirror/codename string ucs430
		d-i mirror/suite string ucs430
		d-i mirror/udeb/suite string ucs430
		...
		d-i base-installer/kernel/image string linux-image-4.9.0-6-amd64
