...
# prepare image
_ssh "guestfish add $kvm_template  : run : mount /dev/mapper/vg_ucs-root / : command 'ucr unset --force auth/sshd/user/root' : mkdir-p /root/.ssh/ : write /root/.ssh/authorized_keys 'ssh-rsa  tech'"
