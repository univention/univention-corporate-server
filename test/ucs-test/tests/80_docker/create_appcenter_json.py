...
class App(object):
	...
	def important_files(self):
		...
		for docker_file in ['setup', 'store_data', 'restore_data_before_setup', 'restore_data_after_setup', 'update_available', 'update_packages', 'update_release', 'update_app_version', 'univention-config-registry-variables', 'schema', 'preinst', 'inst', 'init', 'prerm', 'uinst']:
