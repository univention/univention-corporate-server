...
def extension_type(request):
	print('========================= TESTING EXTENSION %s =============================' % request.param)
...
@pytest.fixture
def joinscript_buffer(package_name, extension_filename):
...
def test_register_deregister_via_joinscript(extension_type, extension_name, extension_filename, package_name, joinscript_buffer):
