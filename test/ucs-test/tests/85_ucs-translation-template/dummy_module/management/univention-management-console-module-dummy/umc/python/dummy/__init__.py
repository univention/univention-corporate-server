...
class Instance(Base):
	...
	def colors(self, request):
		...
		MODULE.info('dummy.colors: options: %s' % str(request.options))
		...
		MODULE.info('dummy.colors: result: %s' % str(allColors))
	...
	def query(self, request):
		...
		"""
		MODULE.info('dummy.query: options: %s' % str(request.options))
		...
		MODULE.info('dummy.query: results: %s' % str(result))
	...
	def get(self, request):
		...
		return: [ { 'id' : <unique identifier>, 'name' : <display name>, 'color' : <name of favorite color> }, ... ]
		"""
		MODULE.info('dummy.get: options: %s' % str(request.options))
		ids = request.options
		result = []
