...
from tasks.computers_domaincontroller_slave.computers_domaincontroller_slave_get import computers_domaincontroller_slave_get
from tasks.computers_domaincontroller_slave.computers_domaincontroller_slave_post import computers_domaincontroller_slave_post
from tasks.computers_domaincontroller_slave.computers_domaincontroller_slave_add_get import computers_domaincontroller_slave_add_get
from tasks.computers_domaincontroller_slave.computers_domaincontroller_slave_dn_get import computers_domaincontroller_slave_dn_get
from tasks.computers_domaincontroller_slave.computers_domaincontroller_slave_dn_delete import computers_domaincontroller_slave_dn_delete
