# Path: test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks/locustfiles/tasks/computers_domaincontroller_slave/computers_domaincontroller_slave_dn_get.py
...
def computers_domaincontroller_slave_dn_get(self):
    ...
    self.request('get', f'/univention/udm/computers/domaincontroller_slave/{dn}', name='/computers/domaincontroller_slave/{dn}', headers=header, verify=False, response_codes=[200])
