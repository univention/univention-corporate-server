# Path: test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks/locustfiles/tasks/computers_domaincontroller_slave/computers_domaincontroller_slave_dn_patch.py
...
def computers_domaincontroller_slave_dn_patch(self):
    ...
    self.request('patch', f'/univention/udm/computers/domaincontroller_slave/{dn}', name='/computers/domaincontroller_slave/{dn}', headers=header, json=data, verify=False, response_codes=[204])
