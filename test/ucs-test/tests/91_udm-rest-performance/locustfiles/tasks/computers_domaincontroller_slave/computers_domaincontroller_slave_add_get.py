# Path: test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks/locustfiles/tasks/computers_domaincontroller_slave/computers_domaincontroller_slave_add_get.py
