# Path: test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks//home/ivan/univention/ucs/test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks/container_ou/container_ou_get.py
# Search for Organisational Units objects
...
def container_ou_get(self):
    ...
    self.request('get', '/univention/udm/container/ou/', name='/container/ou/', headers=header, params=query, verify=False, response_codes=[200])
