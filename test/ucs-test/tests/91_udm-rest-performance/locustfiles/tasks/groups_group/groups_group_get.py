# Path: test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks//home/ivan/univention/ucs/test/ucs-test/tests/91_udm-performance-test/locustfiles/tasks/groups_group/groups_group_get.py
...
def groups_group_get(self):
    ...
    query = {
        'filter': '(name=1*)',  # A LDAP filter which may contain `UDM` property names instead of `LDAP` attribute names. (string)
