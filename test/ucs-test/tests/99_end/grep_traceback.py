...
COMMON_EXCEPTIONS = (
    ...
    E(r'.*OperationalError.*FATAL:.*admindiary.*', [r'admindiary_backend_wrapper\.py', 'sqlalchemy/pool/base.py.*in connect'], 51671),
    ...
    E(r'RuntimeError: fetch\(\) called on closed AsyncHTTPClient', ['console/resources.py".*in cancel_request'], 58873),
    E(r'BrokenPipeError: \[Errno 32\].* [bB]roken pipe', ['rest/__main__.py.*in signal_handler_reload'], 59577),
