...
class OIDCLogin(FastHttpUser):
    ...
    def task1(self):
        ...
        # 5-10. login
        umc_session_id = login_via_oidc(self.client, self.username, self.password, prefix='05', oidc_entry='/univention/portal/login', session_cookie_name='portal_session_id')
