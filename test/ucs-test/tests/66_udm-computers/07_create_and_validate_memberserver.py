...
## desc: Create maximal computers/memberserver and validate it's attributes as well as automatically created referring objects and group memberships
## tags: [udm-computers]
...
if __name__ == '__main__':
	...
	objectType = 'computers/memberserver'
	with udm_test.UCSTestUDM() as udm:
		...
		expectedLdap = {
			...
			'univentionServerRole': [properties['serverRole'], 'member'],
