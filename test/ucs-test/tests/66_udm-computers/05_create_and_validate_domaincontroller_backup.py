...
## desc: Create maximal computers/domaincontroller_backup and validate it's attributes as well as automatically created referring objects and group memberships
## tags: [udm-computers]
...
if __name__ == '__main__':
	...
	objectType = 'computers/domaincontroller_backup'
	with udm_test.UCSTestUDM() as udm:
		...
		expectedLdap = {
			...
			'univentionServerRole': [properties['serverRole'], 'backup'],
