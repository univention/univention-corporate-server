...
## desc: Create maximal computers/domaincontroller_master and validate it's attributes as well as automatically created referring objects and group memberships
## tags: [udm-computers]
...
if __name__ == '__main__':
	...
	objectType = 'computers/domaincontroller_master'
	with udm_test.UCSTestUDM() as udm:
		...
		properties = {
			...
			'reinstall': '1',
			'reinstalltext': '1',
			'reinstalloption': uts.random_string(),
		...
		expectedLdap = {
			...
			'univentionService': [properties['service']],
			'homeDirectory': [properties['unixhome']],
			'univentionServerRole': [properties['serverRole'], 'master'],
			...
			'univentionServerInstallationOption': [properties['reinstalloption']],
			'univentionServerInstallationProfile': [properties['instprofile']],
