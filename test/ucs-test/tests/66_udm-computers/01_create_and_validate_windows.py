...
## desc: Create maximal computers/windows and validate it's attributes as well as automatically created referring objects and group memberships
## tags: [udm-computers]
...
if __name__ == '__main__':
	...
	with udm_test.UCSTestUDM() as udm:
		...
		expectedLdap = {
			...
			'sambaNTPassword': [smbpasswd.nthash(properties['name'].lower())],
