...
class TestUMCExtendedAttributes(UDMModule):
    ...
    def __init__(self):
        ...
        super(TestUMCExtendedAttributes, self).__init__()
        self.ldap_base = ''
    ...
    def modify_check_user_attribute(self, user_dn, attribute_key,
        ...
        try:
            ...
            utils.fail("A KeyError exception while trying to check and modify the user attribute '%s' value: '%s'" % (attribute_key, exc))
