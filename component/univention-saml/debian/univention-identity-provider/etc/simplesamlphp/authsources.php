...
$config = array(
	...
	*/
	...
	'example-userpass' => array(
		...
		'fbest:anonymous' => array(
			'uid' => array('fbest'),
			'eduPersonAffiliation' => array('member', 'fbest'),
		),
		'groth:zungenbrecher' => array(
			'uid' => array('groth'),
			'eduPersonAffiliation' => array('member', 'groth'),
		),
		'alex:kapusta' => array(
			'uid' => array('alex'),
			'eduPersonAffiliation' => array('member', 'alex'),
		),
	),
	*/
	...
	*/
	...
	'univention-ldap' => array(
		...
		//'hostname' => 'ec2-54-216-34-148.eu-west-1.compute.amazonaws.com',
		//'hostname' => 'master-jgroth.intra.local',
		'hostname' => '127.0.0.1',
