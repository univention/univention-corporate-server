...
#	define seterrobj(n) { \
	...
	seterrobj(KDC_ERROR_CLIENT_NOT_TRUSTED);
	seterrobj(KDC_ERROR_KDC_NOT_TRUSTED);
	seterrobj(KDC_ERROR_INVALID_SIG);
	seterrobj(KDC_ERROR_KEY_TOO_WEAK);
	seterrobj(KDC_ERROR_CERTIFICATE_MISMATCH);
	seterrobj(KRB5_AP_ERR_USER_TO_USER_REQUIRED);
	seterrobj(KDC_ERROR_CANT_VERIFY_CERTIFICATE);
	seterrobj(KDC_ERROR_INVALID_CERTIFICATE);
	seterrobj(KDC_ERROR_REVOKED_CERTIFICATE);
	seterrobj(KDC_ERROR_REVOCATION_STATUS_UNKNOWN);
	seterrobj(KDC_ERROR_REVOCATION_STATUS_UNAVAILABLE);
	seterrobj(KDC_ERROR_CLIENT_NAME_MISMATCH);
	seterrobj(KDC_ERROR_KDC_NAME_MISMATCH);
	...
	seterrobj(KRB5_KT_NAME_TOOLONG);
#endif
}
