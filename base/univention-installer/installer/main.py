...
class mods:
	...
	def header(self):
		...
		return objects.headline(_(' Univention Corporate Server %s (%s)' % (self.cmdline.get('version', ''), codename)),max_y/2-12,max_x/2-35)
	...
	def input(self,key):
		...
		elif key in [ 3, 9, 10, 27 ] + range(32,277) + [ 360 ]:
