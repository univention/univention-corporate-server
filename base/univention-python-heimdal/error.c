...
#	define seterrobj(n) { \
	...
	seterrobj(KRB5_KDC_ERR_KEY_SIZE);
	seterrobj(KRB5_KDC_ERR_CERTIFICATE_MISMATCH);
	seterrobj(KRB5_AP_ERR_USER_TO_USER_REQUIRED);
	seterrobj(KRB5_KDC_ERROR_CANT_VERIFY_CERTIFICATE);
	seterrobj(KRB5_KDC_ERROR_INVALID_CERTIFICATE);
	seterrobj(KRB5_KDC_ERROR_REVOKED_CERTIFICATE);
	seterrobj(KRB5_KDC_ERROR_REVOCATION_STATUS_UNKNOWN);
	seterrobj(KRB5_KDC_ERROR_REVOCATION_STATUS_UNAVAILABLE);
	seterrobj(KRB5_KDC_ERROR_CLIENT_NAME_MISMATCH);
	seterrobj(KRB5_KDC_ERROR_KDC_NAME_MISMATCH);
