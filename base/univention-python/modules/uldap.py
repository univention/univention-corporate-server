...
def getRootDnConnection(start_tls=None, decode_ignorelist=None, reconnect=True):
    # type: (int, None, bool) -> access
    """
...
def getAdminConnection(start_tls=None, decode_ignorelist=None, reconnect=True):
    # type: (int, None, bool) -> access
    """
...
def getBackupConnection(start_tls=None, decode_ignorelist=None, reconnect=True):
    # type: (int, None, bool) -> access
    """
...
def getMachineConnection(start_tls=None, decode_ignorelist=None, ldap_master=True, secret_file="/etc/machine.secret", reconnect=True, random_server=False):
    # type: (int, None, bool, str, bool, bool) -> access
    """
...
class access(object):
    ...
    def __init__(self, host='localhost', port=None, base='', binddn='', bindpw='', start_tls=None, ca_certfile=None, decode_ignorelist=None, use_ldaps=False, uri=None, follow_referral=False, reconnect=True):
        # type: (str, int, str, Optional[str], str, int, str, None, bool, str, bool, bool) -> None
        self.host = host
        self.base = base
        self.binddn = binddn
