	...
	return declare("umc.modules.updater", Module, {
		...
		_call_installer: function(args) {
			...
			if (args.confirm) {
				...
				if (args.detail) {
					msg += '<li>' + _('Consider <a href="https://docs.software-univention.de/release-notes-%s-en.html" target="_blank">release notes and changelogs</a> as well as references posted in the <a href="http://forum.univention.de/viewforum.php?f=54" targe="_blank">Univention Forum</a>.', args.detail) + '</li>';
				}
				else {
					msg += '<li>' + _('Consider <a href="https://docs.software-univention.de/" target="_blank">release notes and changelogs</a> as well as references posted in the <a href="http://forum.univention.de/viewforum.php?f=54" targe="_blank">Univention Forum</a>.') + '</li>';
				}
				msg += '</ul>';
