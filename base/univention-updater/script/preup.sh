...
echo " English version: https://docs.software-univention.de/release-notes-4.2-4-en.html"
echo " German version:  https://docs.software-univention.de/release-notes-4.2-4-de.html"
echo
