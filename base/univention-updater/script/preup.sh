...
echo " English version: https://docs.software-univention.de/release-notes-4.3-5-en.html"
echo " German version:  https://docs.software-univention.de/release-notes-4.3-5-de.html"
echo
