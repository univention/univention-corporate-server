...
echo " English version: https://docs.software-univention.de/release-notes-4.1-2-en.html"
echo " German version:  https://docs.software-univention.de/release-notes-4.1-2-de.html"
echo
