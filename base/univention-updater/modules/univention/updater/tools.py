...
class Component(object):
    ...
    def repositories(self, start: UCS_Version, end: UCS_Version, clean: bool=False, for_mirror_list: bool=False, failed: Set[Tuple[Component, str]] | None=None) -> Iterator[str]:
        """
