			...
			lang.mixin(this, {
				pages: [{
					...
					widgets: [{
						...
						type: Text,
						content: _('More details about the activation can be found in the <a href="https://docs.software-univention.de/manual.html#central:license" target="_blank">UCS manual</a>.'),
						name: 'moreDetails'
					}, {
						type: Text,
