	...
	return declare("ActivationWizard", [ Wizard ], {
		...
		_showEmailError: function(err) {
			...
			if (status_code >= 400) {
				...
				error_details = _('An unknown error occured. It is possible that a browser addon blocks sending the request to "license.univention.de". More information how to avoid this error can be found <a href="https://help.univention.com/t/7698">in our support database</a>');
			}
