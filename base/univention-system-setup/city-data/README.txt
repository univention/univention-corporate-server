...
The list of cities has been taken from Geonames.org (see also Readme below):
http://download.geonames.org/export/dump/

The list of nameservers has been retrieved via:
http://www.ungefiltert-surfen.de/nameservers.json

The list of default keyboard layouts is obtained from the Univention package univention-installer.

See also:
* localechooser: git://anonscm.debian.org/d-i/localechooser.git
