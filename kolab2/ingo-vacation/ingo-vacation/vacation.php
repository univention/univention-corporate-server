<?php
/**
 * $Horde: ingo/vacation.php,v 1.28.8.11 2008/04/30 22:11:50 chuck Exp $
 *
...
require_once INGOVACATION_BASE . '/lib/base.php';
...
require INGOVACATION_TEMPLATES . '/common-header.inc';
require INGOVACATION_TEMPLATES . '/menu.inc';
