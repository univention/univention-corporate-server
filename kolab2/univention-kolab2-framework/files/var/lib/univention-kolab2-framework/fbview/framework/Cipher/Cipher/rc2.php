 ...
 *
 * $Horde: framework/Cipher/Cipher/rc2.php,v 1.9 2004/01/01 15:14:10 jan Exp $
 *
...
class Horde_Cipher_rc2 extends Horde_Cipher {
    ...
    /* Constructor */
    function Horde_Cipher_rc2($params = null)
    {
    }
    ...
    function encryptBlock($block, $key = null)
    {
        ...
        $encrypted = pack("v*", $plain[1], $plain[2], $plain[3], $plain[4]);
        return $encrypted;
    }
