<?php
/**
 * The Cipher_des:: class implements the Cipher interface enryption data
 * using the Data Encryption Standard (DES) algorithm as define in FIPS46-3.
 *
 * $Horde: framework/Cipher/Cipher/des.php,v 1.4 2004/01/01 15:14:10 jan Exp $
 *
...
class Horde_Cipher_des extends Horde_Cipher {
    ...
    /* Constructor */
    function Horde_Cipher_des($params = null)
    {
    }
