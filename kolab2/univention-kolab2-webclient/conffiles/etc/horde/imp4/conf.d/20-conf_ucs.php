...
//
// 	/etc/univention/templates/files/etc/horde/imp4/conf.ucs.php
//
...
@!@
if configRegistry.get('horde/menu/hide_groupware','false') in ['1','yes','true']:
	print "$conf['hooks']['display'] = true;"
@!@
